...
//     int acc_ptr = 0;
//     for (int i = 0; i < static_cast<int>(sorted_decoded_vocab.size()); ++i) {
//       while (acc_ptr < static_cast<int>(accepted_indices.size()) && accepted_indices[acc_ptr] <
//       i) {
//         ++acc_ptr;
//       }
...
//     int rej_ptr = 0;
//     for (int i = 0; i < static_cast<int>(sorted_decoded_vocab.size()); ++i) {
//       while (rej_ptr < static_cast<int>(rejected_indices.size()) && rejected_indices[rej_ptr] <
//       i) {
//         ++rej_ptr;
//       }
...
//      << ", accepted_num=" << accepted_indices.size() << ", rejected_num=" <<
...
//   auto grammar = Grammar::FromJSONSchema(schema, any_whitespace, indent, separators,
//   strict_mode); return MultiThreadCompileGrammar(grammar);
// }
