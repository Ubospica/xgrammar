...
//   RulePosition UpdatePositionWithChar(const RulePosition& rule_position, uint8_t char_value)
//   const;
...
//    * \param consider_parent Whether consider expanding the elements in the parent rule. Useful
//    for
//    * inner recursion.
