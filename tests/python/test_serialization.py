...
def test_serialize_byte_regex_flags_and_legacy_version_boundary():
    """Byte flags round-trip in v18, while v16 data is rejected before interpreting them."""
    ...
    for regex_flags in [2, 3]:
        ...
        with pytest.raises(xgr.DeserializeVersionError, match="Got v16, expected v18"):
